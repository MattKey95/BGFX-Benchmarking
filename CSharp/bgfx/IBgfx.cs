...
public partial class Bgfx : IBgfx
{
	[DllImport(DllName, EntryPoint="bgfx_attachment_init", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_attachment_init(Attachment* _this, TextureHandle _handle, Access _access, ushort _layer, ushort _numLayers, ushort _mip, byte _resolve);
	/// <summary>
	/// Init attachment.
	/// </summary>
	///
	...
	///
	public unsafe void attachment_init(Attachment* _this, TextureHandle _handle, Access _access, ushort _layer, ushort _numLayers, ushort _mip, byte _resolve)
	{
	...
	private static extern unsafe VertexLayout* bgfx_vertex_layout_begin(VertexLayout* _this, RendererType _rendererType);
	/// <summary>
	/// Start VertexLayout.
	/// </summary>
	///
	...
	///
	public unsafe VertexLayout* vertex_layout_begin(VertexLayout* _this, RendererType _rendererType)
	{
	...
	private static extern unsafe VertexLayout* bgfx_vertex_layout_add(VertexLayout* _this, Attrib _attrib, byte _num, AttribType _type, bool _normalized, bool _asInt);
	/// <summary>
	...
	///
	public unsafe VertexLayout* vertex_layout_add(VertexLayout* _this, Attrib _attrib, byte _num, AttribType _type, bool _normalized, bool _asInt)
	{
	...
	private static extern unsafe void bgfx_vertex_layout_decode(VertexLayout* _this, Attrib _attrib, byte * _num, AttribType* _type, bool* _normalized, bool* _asInt);
	/// <summary>
	/// Decode attribute.
	/// </summary>
	///
	...
	///
	public unsafe void vertex_layout_decode(VertexLayout* _this, Attrib _attrib, byte * _num, AttribType* _type, bool* _normalized, bool* _asInt)
	{
	...
	private static extern unsafe bool bgfx_vertex_layout_has(VertexLayout* _this, Attrib _attrib);
	/// <summary>
	...
	/// <param name="_attrib">Attribute semantics. See: `bgfx::Attrib`</param>
	///
	public unsafe bool vertex_layout_has(VertexLayout* _this, Attrib _attrib)
	{
	...
	private static extern unsafe VertexLayout* bgfx_vertex_layout_skip(VertexLayout* _this, byte _num);
	/// <summary>
	...
	///
	public unsafe VertexLayout* vertex_layout_skip(VertexLayout* _this, byte _num)
	{
	...
	private static extern unsafe void bgfx_vertex_layout_end(VertexLayout* _this);
	/// <summary>
	/// End VertexLayout.
	/// </summary>
	///
	public unsafe void vertex_layout_end(VertexLayout* _this)
	{
		bgfx_vertex_layout_end(_this);
	}

	[DllImport(DllName, EntryPoint="bgfx_vertex_pack", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_vertex_pack(float _input, bool _inputNormalized, Attrib _attr, VertexLayout* _layout, void* _data, uint _index);
	/// <summary>
	...
	///
	public unsafe void vertex_pack(float _input, bool _inputNormalized, Attrib _attr, VertexLayout* _layout, void* _data, uint _index)
	{
	...
	private static extern unsafe void bgfx_vertex_unpack(float _output, Attrib _attr, VertexLayout* _layout, void* _data, uint _index);
	/// <summary>
	...
	///
	public unsafe void vertex_unpack(float _output, Attrib _attr, VertexLayout* _layout, void* _data, uint _index)
	{
	...
	private static extern unsafe void bgfx_vertex_convert(VertexLayout* _dstLayout, void* _dstData, VertexLayout* _srcLayout, void* _srcData, uint _num);
	/// <summary>
	...
	///
	public unsafe void vertex_convert(VertexLayout* _dstLayout, void* _dstData, VertexLayout* _srcLayout, void* _srcData, uint _num)
	{
	...
	private static extern unsafe uint bgfx_weld_vertices(void* _output, VertexLayout* _layout, void* _data, uint _num, bool _index32, float _epsilon);
	/// <summary>
	/// Weld vertices.
	/// </summary>
	///
	...
	///
	public unsafe uint weld_vertices(void* _output, VertexLayout* _layout, void* _data, uint _num, bool _index32, float _epsilon)
	{
	...
	private static extern unsafe uint bgfx_topology_convert(TopologyConvert _conversion, void* _dst, uint _dstSize, void* _indices, uint _numIndices, bool _index32);
	/// <summary>
	...
	/// <param name="_index32">Set to `true` if input indices are 32-bit.</param>
	///
	public unsafe uint topology_convert(TopologyConvert _conversion, void* _dst, uint _dstSize, void* _indices, uint _numIndices, bool _index32)
	{
	...
	private static extern unsafe void bgfx_topology_sort_tri_list(TopologySort _sort, void* _dst, uint _dstSize, float _dir, float _pos, void* _vertices, uint _stride, void* _indices, uint _numIndices, bool _index32);
	/// <summary>
	/// Sort indices.
	/// </summary>
	///
	...
	/// <param name="_index32">Set to `true` if input indices are 32-bit.</param>
	///
	public unsafe void topology_sort_tri_list(TopologySort _sort, void* _dst, uint _dstSize, float _dir, float _pos, void* _vertices, uint _stride, void* _indices, uint _numIndices, bool _index32)
	{
	...
	private static extern unsafe byte bgfx_get_supported_renderers(byte _max, RendererType* _enum);
	/// <summary>
	...
	///
	public unsafe byte get_supported_renderers(byte _max, RendererType* _enum)
	{
	...
	private static extern unsafe IntPtr bgfx_get_renderer_name(RendererType _type);
	/// <summary>
	...
	///
	public unsafe IntPtr get_renderer_name(RendererType _type)
	{
		return bgfx_get_renderer_name(_type);
	}

	[DllImport(DllName, EntryPoint="bgfx_init_ctor", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_init_ctor(Init* _init);
	public unsafe void init_ctor(Init* _init)
	{
	...
	[return: MarshalAs(UnmanagedType.I1)]
	private static extern unsafe bool bgfx_init(Init* _bgfx_init);
	/// <summary>
	...
	private static extern unsafe void bgfx_reset(uint _width, uint _height, uint _flags, TextureFormat _format);
	/// <summary>
	...
	///
	public unsafe void reset(uint _width, uint _height, uint _flags, TextureFormat _format)
	{
	...
	private static extern unsafe uint bgfx_frame(bool _capture);
	/// <summary>
	...
	///
	public unsafe Memory* alloc(uint _size)
	{
		return bgfx_alloc(_size);
	}

	[DllImport(DllName, EntryPoint="bgfx_copy", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe Memory* bgfx_copy(void* _data, uint _size);
	/// <summary>
	...
	///
	public unsafe Memory* copy(void* _data, uint _size)
	{
		return bgfx_copy(_data,_size);
	}

	[DllImport(DllName, EntryPoint="bgfx_make_ref", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe Memory* bgfx_make_ref(void* _data, uint _size);
	/// <summary>
	...
	///
	public unsafe Memory* make_ref(void* _data, uint _size)
	{
	...
	private static extern unsafe Memory* bgfx_make_ref_release(void* _data, uint _size, IntPtr _releaseFn, void* _userData);
	/// <summary>
	/// Make reference to data to pass to bgfx. Unlike `bgfx::alloc`, this call
	/// doesn't allocate memory for data. It just copies the _data pointer. You
	/// can pass `ReleaseFn` function pointer to release this memory after it's
	...
	///
	public unsafe Memory* make_ref_release(void* _data, uint _size, IntPtr _releaseFn, void* _userData)
	{
	...
	private static extern unsafe void bgfx_set_debug(uint _debug);
	/// <summary>
	/// Set debug flags.
	/// </summary>
	///
	...
	///
	public unsafe void set_debug(uint _debug)
	{
		bgfx_set_debug(_debug);
	}

	[DllImport(DllName, EntryPoint="bgfx_dbg_text_clear", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_dbg_text_clear(byte _attr, bool _small);
	/// <summary>
	...
	///
	public unsafe void dbg_text_clear(byte _attr, bool _small)
	{
	...
	private static extern unsafe void bgfx_dbg_text_printf(ushort _x, ushort _y, byte _attr, [MarshalAs(UnmanagedType.LPStr)] string _format, [MarshalAs(UnmanagedType.LPStr)] string args );
	/// <summary>
	...
	///
	public unsafe void dbg_text_printf(ushort _x, ushort _y, byte _attr, [MarshalAs(UnmanagedType.LPStr)] string _format, [MarshalAs(UnmanagedType.LPStr)] string _args)
	{
		bgfx_dbg_text_printf(_x,_y,_attr,_format,_args);
	}

	[DllImport(DllName, EntryPoint="bgfx_dbg_text_vprintf", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_dbg_text_vprintf(ushort _x, ushort _y, byte _attr, [MarshalAs(UnmanagedType.LPStr)] string _format, IntPtr _argList);
	/// <summary>
	...
	///
	public unsafe void dbg_text_vprintf(ushort _x, ushort _y, byte _attr, [MarshalAs(UnmanagedType.LPStr)] string _format, IntPtr _argList)
	{
	...
	private static extern unsafe void bgfx_dbg_text_image(ushort _x, ushort _y, ushort _width, ushort _height, void* _data, ushort _pitch);
	/// <summary>
	...
	///
	public unsafe void dbg_text_image(ushort _x, ushort _y, ushort _width, ushort _height, void* _data, ushort _pitch)
	{
	...
	private static extern unsafe IndexBufferHandle bgfx_create_index_buffer(Memory* _mem, ushort _flags);
	/// <summary>
	...
	///
	public unsafe IndexBufferHandle create_index_buffer(Memory* _mem, ushort _flags)
	{
	...
	private static extern unsafe void bgfx_set_index_buffer_name(IndexBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	/// <summary>
	...
	///
	public unsafe void set_index_buffer_name(IndexBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len)
	{
	...
	private static extern unsafe void bgfx_destroy_index_buffer(IndexBufferHandle _handle);
	/// <summary>
	...
	/// <param name="_handle">Static index buffer handle.</param>
	///
	public unsafe void destroy_index_buffer(IndexBufferHandle _handle)
	{
	...
	private static extern unsafe VertexLayoutHandle bgfx_create_vertex_layout(VertexLayout* _layout);
	/// <summary>
	...
	///
	public unsafe VertexLayoutHandle create_vertex_layout(VertexLayout* _layout)
	{
	...
	private static extern unsafe void bgfx_destroy_vertex_layout(VertexLayoutHandle _layoutHandle);
	/// <summary>
	...
	///
	public unsafe void destroy_vertex_layout(VertexLayoutHandle _layoutHandle)
	{
	...
	private static extern unsafe VertexBufferHandle bgfx_create_vertex_buffer(Memory* _mem, VertexLayout* _layout, ushort _flags);
	/// <summary>
	...
	/// <param name="_flags">Buffer creation flags.  - `BGFX_BUFFER_NONE` - No flags.  - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.  - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer      is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.  - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.  - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of      data is passed. If this flag is not specified, and more data is passed on update, the buffer      will be trimmed to fit the existing buffer size. This flag has effect only on dynamic buffers.  - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on index buffers.</param>
	///
	public unsafe VertexBufferHandle create_vertex_buffer(Memory* _mem, VertexLayout* _layout, ushort _flags)
	{
	...
	private static extern unsafe void bgfx_set_vertex_buffer_name(VertexBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	/// <summary>
	...
	///
	public unsafe void set_vertex_buffer_name(VertexBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len)
	{
	...
	private static extern unsafe void bgfx_destroy_vertex_buffer(VertexBufferHandle _handle);
	/// <summary>
	...
	/// <param name="_handle">Static vertex buffer handle.</param>
	///
	public unsafe void destroy_vertex_buffer(VertexBufferHandle _handle)
	{
	...
	private static extern unsafe DynamicIndexBufferHandle bgfx_create_dynamic_index_buffer(uint _num, ushort _flags);
	/// <summary>
	...
	/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
	///
	public unsafe DynamicIndexBufferHandle create_dynamic_index_buffer(uint _num, ushort _flags)
	{
	...
	private static extern unsafe DynamicIndexBufferHandle bgfx_create_dynamic_index_buffer_mem(Memory* _mem, ushort _flags);
	/// <summary>
	...
	/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
	///
	public unsafe DynamicIndexBufferHandle create_dynamic_index_buffer_mem(Memory* _mem, ushort _flags)
	{
	...
	private static extern unsafe void bgfx_update_dynamic_index_buffer(DynamicIndexBufferHandle _handle, uint _startIndex, Memory* _mem);
	/// <summary>
	...
	/// <param name="_mem">Index buffer data.</param>
	///
	public unsafe void update_dynamic_index_buffer(DynamicIndexBufferHandle _handle, uint _startIndex, Memory* _mem)
	{
	...
	private static extern unsafe void bgfx_destroy_dynamic_index_buffer(DynamicIndexBufferHandle _handle);
	/// <summary>
	...
	/// <param name="_handle">Dynamic index buffer handle.</param>
	///
	public unsafe void destroy_dynamic_index_buffer(DynamicIndexBufferHandle _handle)
	{
	...
	private static extern unsafe DynamicVertexBufferHandle bgfx_create_dynamic_vertex_buffer(uint _num, VertexLayout* _layout, ushort _flags);
	/// <summary>
	...
	/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
	///
	public unsafe DynamicVertexBufferHandle create_dynamic_vertex_buffer(uint _num, VertexLayout* _layout, ushort _flags)
	{
	...
	private static extern unsafe DynamicVertexBufferHandle bgfx_create_dynamic_vertex_buffer_mem(Memory* _mem, VertexLayout* _layout, ushort _flags);
	/// <summary>
	...
	/// <param name="_flags">Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   - `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   - `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit indices. This flag has effect only on       index buffers.</param>
	///
	public unsafe DynamicVertexBufferHandle create_dynamic_vertex_buffer_mem(Memory* _mem, VertexLayout* _layout, ushort _flags)
	{
	...
	private static extern unsafe void bgfx_update_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle, uint _startVertex, Memory* _mem);
	/// <summary>
	...
	/// <param name="_mem">Vertex buffer data.</param>
	///
	public unsafe void update_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle, uint _startVertex, Memory* _mem)
	{
	...
	private static extern unsafe void bgfx_destroy_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle);
	/// <summary>
	...
	/// <param name="_handle">Dynamic vertex buffer handle.</param>
	///
	public unsafe void destroy_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle)
	{
	...
	private static extern unsafe uint bgfx_get_avail_transient_index_buffer(uint _num, bool _index32);
	/// <summary>
	...
	///
	public unsafe uint get_avail_transient_index_buffer(uint _num, bool _index32)
	{
	...
	private static extern unsafe uint bgfx_get_avail_transient_vertex_buffer(uint _num, VertexLayout* _layout);
	/// <summary>
	...
	/// <param name="_layout">Vertex layout.</param>
	///
	public unsafe uint get_avail_transient_vertex_buffer(uint _num, VertexLayout* _layout)
	{
	...
	private static extern unsafe uint bgfx_get_avail_instance_data_buffer(uint _num, ushort _stride);
	/// <summary>
	...
	///
	public unsafe uint get_avail_instance_data_buffer(uint _num, ushort _stride)
	{
	...
	private static extern unsafe void bgfx_alloc_transient_index_buffer(TransientIndexBuffer* _tib, uint _num, bool _index32);
	/// <summary>
	...
	/// <param name="_index32">Set to `true` if input indices will be 32-bit.</param>
	///
	public unsafe void alloc_transient_index_buffer(TransientIndexBuffer* _tib, uint _num, bool _index32)
	{
	...
	private static extern unsafe void bgfx_alloc_transient_vertex_buffer(TransientVertexBuffer* _tvb, uint _num, VertexLayout* _layout);
	/// <summary>
	...
	/// <param name="_layout">Vertex layout.</param>
	///
	public unsafe void alloc_transient_vertex_buffer(TransientVertexBuffer* _tvb, uint _num, VertexLayout* _layout)
	{
	...
	[return: MarshalAs(UnmanagedType.I1)]
	private static extern unsafe bool bgfx_alloc_transient_buffers(TransientVertexBuffer* _tvb, VertexLayout* _layout, uint _numVertices, TransientIndexBuffer* _tib, uint _numIndices, bool _index32);
	/// <summary>
	...
	/// <param name="_index32">Set to `true` if input indices will be 32-bit.</param>
	///
	public unsafe bool alloc_transient_buffers(TransientVertexBuffer* _tvb, VertexLayout* _layout, uint _numVertices, TransientIndexBuffer* _tib, uint _numIndices, bool _index32)
	{
	...
	private static extern unsafe void bgfx_alloc_instance_data_buffer(InstanceDataBuffer* _idb, uint _num, ushort _stride);
	/// <summary>
	...
	///
	public unsafe void alloc_instance_data_buffer(InstanceDataBuffer* _idb, uint _num, ushort _stride)
	{
	...
	private static extern unsafe IndirectBufferHandle bgfx_create_indirect_buffer(uint _num);
	/// <summary>
	...
	///
	public unsafe IndirectBufferHandle create_indirect_buffer(uint _num)
	{
	...
	private static extern unsafe void bgfx_destroy_indirect_buffer(IndirectBufferHandle _handle);
	/// <summary>
	...
	///
	public unsafe void destroy_indirect_buffer(IndirectBufferHandle _handle)
	{
	...
	private static extern unsafe ShaderHandle bgfx_create_shader(Memory* _mem);
	/// <summary>
	...
	///
	public unsafe ShaderHandle create_shader(Memory* _mem)
	{
	...
	private static extern unsafe ushort bgfx_get_shader_uniforms(ShaderHandle _handle, UniformHandle* _uniforms, ushort _max);
	/// <summary>
	...
	///
	public unsafe ushort get_shader_uniforms(ShaderHandle _handle, UniformHandle* _uniforms, ushort _max)
	{
	...
	private static extern unsafe void bgfx_set_shader_name(ShaderHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	/// <summary>
	...
	///
	public unsafe void set_shader_name(ShaderHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len)
	{
	...
	private static extern unsafe void bgfx_destroy_shader(ShaderHandle _handle);
	/// <summary>
	/// Destroy shader.
	...
	/// <param name="_handle">Shader handle.</param>
	///
	public unsafe void destroy_shader(ShaderHandle _handle)
	{
		bgfx_destroy_shader(_handle);
	}

	[DllImport(DllName, EntryPoint="bgfx_create_program", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe ProgramHandle bgfx_create_program(ShaderHandle _vsh, ShaderHandle _fsh, bool _destroyShaders);
	/// <summary>
	...
	///
	public unsafe ProgramHandle create_program(ShaderHandle _vsh, ShaderHandle _fsh, bool _destroyShaders)
	{
	...
	private static extern unsafe ProgramHandle bgfx_create_compute_program(ShaderHandle _csh, bool _destroyShaders);
	/// <summary>
	...
	/// <param name="_destroyShaders">If true, shaders will be destroyed when program is destroyed.</param>
	///
	public unsafe ProgramHandle create_compute_program(ShaderHandle _csh, bool _destroyShaders)
	{
	...
	private static extern unsafe void bgfx_destroy_program(ProgramHandle _handle);
	/// <summary>
	/// Destroy program.
	/// </summary>
	///
	...
	///
	public unsafe void destroy_program(ProgramHandle _handle)
	{
	...
	[return: MarshalAs(UnmanagedType.I1)]
	private static extern unsafe bool bgfx_is_texture_valid(ushort _depth, bool _cubeMap, ushort _numLayers, TextureFormat _format, ulong _flags);
	/// <summary>
	...
	///
	public unsafe bool is_texture_valid(ushort _depth, bool _cubeMap, ushort _numLayers, TextureFormat _format, ulong _flags)
	{
	...
	[return: MarshalAs(UnmanagedType.I1)]
	private static extern unsafe bool bgfx_is_frame_buffer_valid(byte _num, Attachment* _attachment);
	/// <summary>
	...
	///
	public unsafe bool is_frame_buffer_valid(byte _num, Attachment* _attachment)
	{
	...
	private static extern unsafe void bgfx_calc_texture_size(TextureInfo* _info, ushort _width, ushort _height, ushort _depth, bool _cubeMap, bool _hasMips, ushort _numLayers, TextureFormat _format);
	/// <summary>
	...
	/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
	///
	public unsafe void calc_texture_size(TextureInfo* _info, ushort _width, ushort _height, ushort _depth, bool _cubeMap, bool _hasMips, ushort _numLayers, TextureFormat _format)
	{
	...
	private static extern unsafe TextureHandle bgfx_create_texture(Memory* _mem, ulong _flags, byte _skip, TextureInfo* _info);
	/// <summary>
	...
	///
	public unsafe TextureHandle create_texture(Memory* _mem, ulong _flags, byte _skip, TextureInfo* _info)
	{
	...
	private static extern unsafe TextureHandle bgfx_create_texture_2d(ushort _width, ushort _height, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem);
	/// <summary>
	/// Create 2D texture.
	/// </summary>
	///
	...
	///
	public unsafe TextureHandle create_texture_2d(ushort _width, ushort _height, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem)
	{
	...
	private static extern unsafe TextureHandle bgfx_create_texture_2d_scaled(BackbufferRatio _ratio, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags);
	/// <summary>
	...
	/// <param name="_flags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
	///
	public unsafe TextureHandle create_texture_2d_scaled(BackbufferRatio _ratio, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags)
	{
	...
	private static extern unsafe TextureHandle bgfx_create_texture_3d(ushort _width, ushort _height, ushort _depth, bool _hasMips, TextureFormat _format, ulong _flags, Memory* _mem);
	/// <summary>
	/// Create 3D texture.
	/// </summary>
	///
	...
	/// <param name="_mem">Texture data. If `_mem` is non-NULL, created texture will be immutable. If `_mem` is NULL content of the texture is uninitialized. When `_numLayers` is more than 1, expected memory layout is texture and all mips together for each array element.</param>
	///
	public unsafe TextureHandle create_texture_3d(ushort _width, ushort _height, ushort _depth, bool _hasMips, TextureFormat _format, ulong _flags, Memory* _mem)
	{
	...
	private static extern unsafe TextureHandle bgfx_create_texture_cube(ushort _size, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem);
	/// <summary>
	/// Create Cube texture.
	/// </summary>
	///
	...
	/// <param name="_mem">Texture data. If `_mem` is non-NULL, created texture will be immutable. If `_mem` is NULL content of the texture is uninitialized. When `_numLayers` is more than 1, expected memory layout is texture and all mips together for each array element.</param>
	///
	public unsafe TextureHandle create_texture_cube(ushort _size, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem)
	{
	...
	private static extern unsafe void bgfx_update_texture_2d(TextureHandle _handle, ushort _layer, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch);
	/// <summary>
	/// Update 2D texture.
	...
	///
	public unsafe void update_texture_2d(TextureHandle _handle, ushort _layer, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch)
	{
	...
	private static extern unsafe void bgfx_update_texture_3d(TextureHandle _handle, byte _mip, ushort _x, ushort _y, ushort _z, ushort _width, ushort _height, ushort _depth, Memory* _mem);
	/// <summary>
	/// Update 3D texture.
	...
	/// <param name="_mem">Texture update data.</param>
	///
	public unsafe void update_texture_3d(TextureHandle _handle, byte _mip, ushort _x, ushort _y, ushort _z, ushort _width, ushort _height, ushort _depth, Memory* _mem)
	{
	...
	private static extern unsafe void bgfx_update_texture_cube(TextureHandle _handle, ushort _layer, byte _side, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch);
	/// <summary>
	/// Update Cube texture.
	...
	/// <param name="_pitch">Pitch of input image (bytes). When _pitch is set to UINT16_MAX, it will be calculated internally based on _width.</param>
	///
	public unsafe void update_texture_cube(TextureHandle _handle, ushort _layer, byte _side, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch)
	{
	...
	private static extern unsafe uint bgfx_read_texture(TextureHandle _handle, void* _data, byte _mip);
	/// <summary>
	...
	/// <param name="_mip">Mip level.</param>
	///
	public unsafe uint read_texture(TextureHandle _handle, void* _data, byte _mip)
	{
	...
	private static extern unsafe void bgfx_set_texture_name(TextureHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	/// <summary>
	...
	///
	public unsafe void set_texture_name(TextureHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len)
	{
	...
	private static extern unsafe void* bgfx_get_direct_access_ptr(TextureHandle _handle);
	/// <summary>
	...
	/// <param name="_handle">Texture handle.</param>
	///
	public unsafe void* get_direct_access_ptr(TextureHandle _handle)
	{
	...
	private static extern unsafe void bgfx_destroy_texture(TextureHandle _handle);
	/// <summary>
	/// Destroy texture.
	/// </summary>
	///
	/// <param name="_handle">Texture handle.</param>
	///
	public unsafe void destroy_texture(TextureHandle _handle)
	{
	...
	private static extern unsafe FrameBufferHandle bgfx_create_frame_buffer(ushort _width, ushort _height, TextureFormat _format, ulong _textureFlags);
	/// <summary>
	...
	///
	public unsafe FrameBufferHandle create_frame_buffer(ushort _width, ushort _height, TextureFormat _format, ulong _textureFlags)
	{
	...
	private static extern unsafe FrameBufferHandle bgfx_create_frame_buffer_scaled(BackbufferRatio _ratio, TextureFormat _format, ulong _textureFlags);
	/// <summary>
	...
	/// <param name="_textureFlags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
	///
	public unsafe FrameBufferHandle create_frame_buffer_scaled(BackbufferRatio _ratio, TextureFormat _format, ulong _textureFlags)
	{
	...
	private static extern unsafe FrameBufferHandle bgfx_create_frame_buffer_from_handles(byte _num, TextureHandle* _handles, bool _destroyTexture);
	/// <summary>
	...
	///
	public unsafe FrameBufferHandle create_frame_buffer_from_handles(byte _num, TextureHandle* _handles, bool _destroyTexture)
	{
	...
	private static extern unsafe FrameBufferHandle bgfx_create_frame_buffer_from_attachment(byte _num, Attachment* _attachment, bool _destroyTexture);
	/// <summary>
	...
	/// <param name="_destroyTexture">If true, textures will be destroyed when frame buffer is destroyed.</param>
	///
	public unsafe FrameBufferHandle create_frame_buffer_from_attachment(byte _num, Attachment* _attachment, bool _destroyTexture)
	{
	...
	private static extern unsafe FrameBufferHandle bgfx_create_frame_buffer_from_nwh(void* _nwh, ushort _width, ushort _height, TextureFormat _format, TextureFormat _depthFormat);
	/// <summary>
	...
	///
	public unsafe FrameBufferHandle create_frame_buffer_from_nwh(void* _nwh, ushort _width, ushort _height, TextureFormat _format, TextureFormat _depthFormat)
	{
	...
	private static extern unsafe void bgfx_set_frame_buffer_name(FrameBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
	/// <summary>
	...
	///
	public unsafe void set_frame_buffer_name(FrameBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len)
	{
	...
	private static extern unsafe TextureHandle bgfx_get_texture(FrameBufferHandle _handle, byte _attachment);
	/// <summary>
	...
	/// <param name="_handle">Frame buffer handle.</param>
	///
	public unsafe TextureHandle get_texture(FrameBufferHandle _handle, byte _attachment)
	{
	...
	private static extern unsafe void bgfx_destroy_frame_buffer(FrameBufferHandle _handle);
	/// <summary>
	...
	/// <param name="_handle">Frame buffer handle.</param>
	///
	public unsafe void destroy_frame_buffer(FrameBufferHandle _handle)
	{
	...
	private static extern unsafe UniformHandle bgfx_create_uniform([MarshalAs(UnmanagedType.LPStr)] string _name, UniformType _type, ushort _num);
	/// <summary>
	...
	///
	public unsafe UniformHandle create_uniform([MarshalAs(UnmanagedType.LPStr)] string _name, UniformType _type, ushort _num)
	{
	...
	private static extern unsafe void bgfx_get_uniform_info(UniformHandle _handle, UniformInfo* _info);
	/// <summary>
	...
	///
	public unsafe void get_uniform_info(UniformHandle _handle, UniformInfo* _info)
	{
	...
	private static extern unsafe void bgfx_destroy_uniform(UniformHandle _handle);
	/// <summary>
	...
	/// <param name="_handle">Handle to uniform object.</param>
	///
	public unsafe void destroy_uniform(UniformHandle _handle)
	{
	...
	private static extern unsafe OcclusionQueryHandle bgfx_create_occlusion_query();
	/// <summary>
	/// Create occlusion query.
	/// </summary>
	///
	public unsafe OcclusionQueryHandle create_occlusion_query()
	{
		return bgfx_create_occlusion_query();
	}

	[DllImport(DllName, EntryPoint="bgfx_get_result", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe OcclusionQueryResult bgfx_get_result(OcclusionQueryHandle _handle, int* _result);
	/// <summary>
	...
	///
	public unsafe OcclusionQueryResult get_result(OcclusionQueryHandle _handle, int* _result)
	{
	...
	private static extern unsafe void bgfx_destroy_occlusion_query(OcclusionQueryHandle _handle);
	/// <summary>
	...
	/// <param name="_handle">Handle to occlusion query object.</param>
	///
	public unsafe void destroy_occlusion_query(OcclusionQueryHandle _handle)
	{
	...
	private static extern unsafe void bgfx_set_palette_color(byte _index, float _rgba);
	/// <summary>
	...
	///
	public unsafe void set_palette_color(byte _index, float _rgba)
	{
	...
	private static extern unsafe void bgfx_set_palette_color_rgba8(byte _index, uint _rgba);
	/// <summary>
	/// Set palette color value.
	/// </summary>
	///
	...
	///
	public unsafe void set_palette_color_rgba8(byte _index, uint _rgba)
	{
	...
	private static extern unsafe void bgfx_set_view_name(ushort _id, [MarshalAs(UnmanagedType.LPStr)] string _name);
	/// <summary>
	/// Set view name.
	/// @remarks
	...
	///
	public unsafe void set_view_name(ushort _id, [MarshalAs(UnmanagedType.LPStr)] string _name)
	{
		bgfx_set_view_name(_id,_name);
	}

	[DllImport(DllName, EntryPoint="bgfx_set_view_rect", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_set_view_rect(ushort _id, ushort _x, ushort _y, ushort _width, ushort _height);
	/// <summary>
	...
	///
	public unsafe void set_view_rect(ushort _id, ushort _x, ushort _y, ushort _width, ushort _height)
	{
	...
	private static extern unsafe void bgfx_set_view_rect_ratio(ushort _id, ushort _x, ushort _y, BackbufferRatio _ratio);
	/// <summary>
	/// Set view rectangle. Draw primitive outside view will be clipped.
	/// </summary>
	///
	...
	///
	public unsafe void set_view_rect_ratio(ushort _id, ushort _x, ushort _y, BackbufferRatio _ratio)
	{
	...
	private static extern unsafe void bgfx_set_view_scissor(ushort _id, ushort _x, ushort _y, ushort _width, ushort _height);
	/// <summary>
	...
	///
	public unsafe void set_view_scissor(ushort _id, ushort _x, ushort _y, ushort _width, ushort _height)
	{
	...
	private static extern unsafe void bgfx_set_view_clear(ushort _id, ushort _flags, uint _rgba, float _depth, byte _stencil);
	/// <summary>
	...
	///
	public unsafe void set_view_clear(ushort _id, ushort _flags, uint _rgba, float _depth, byte _stencil)
	{
	...
	private static extern unsafe void bgfx_set_view_clear_mrt(ushort _id, ushort _flags, float _depth, byte _stencil, byte _c0, byte _c1, byte _c2, byte _c3, byte _c4, byte _c5, byte _c6, byte _c7);
	/// <summary>
	...
	///
	public unsafe void set_view_clear_mrt(ushort _id, ushort _flags, float _depth, byte _stencil, byte _c0, byte _c1, byte _c2, byte _c3, byte _c4, byte _c5, byte _c6, byte _c7)
	{
	...
	private static extern unsafe void bgfx_set_view_mode(ushort _id, ViewMode _mode);
	/// <summary>
	...
	///
	public unsafe void set_view_mode(ushort _id, ViewMode _mode)
	{
	...
	private static extern unsafe void bgfx_set_view_frame_buffer(ushort _id, FrameBufferHandle _handle);
	/// <summary>
	...
	///
	public unsafe void set_view_frame_buffer(ushort _id, FrameBufferHandle _handle)
	{
	...
	private static extern unsafe void bgfx_set_view_transform(ushort _id, void* _view, void* _proj);
	/// <summary>
	...
	///
	public unsafe void set_view_transform(ushort _id, void* _view, void* _proj)
	{
	...
	private static extern unsafe void bgfx_set_view_order(ushort _id, ushort _num, ushort* _order);
	/// <summary>
	...
	///
	public unsafe void set_view_order(ushort _id, ushort _num, ushort* _order)
	{
	...
	private static extern unsafe void bgfx_reset_view(ushort _id);
	/// <summary>
	/// Reset all view settings to default.
	/// </summary>
	///
	public unsafe void reset_view(ushort _id)
	{
		bgfx_reset_view(_id);
	}

	[DllImport(DllName, EntryPoint="bgfx_encoder_begin", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe Encoder* bgfx_encoder_begin(bool _forThread);
	/// <summary>
	...
	///
	public unsafe Encoder* encoder_begin(bool _forThread)
	{
	...
	private static extern unsafe void bgfx_encoder_end(Encoder* _encoder);
	/// <summary>
	...
	///
	public unsafe void encoder_end(Encoder* _encoder)
	{
		bgfx_encoder_end(_encoder);
	}

	[DllImport(DllName, EntryPoint="bgfx_encoder_set_marker", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_encoder_set_marker(Encoder* _this, [MarshalAs(UnmanagedType.LPStr)] string _marker);
	/// <summary>
	...
	///
	public unsafe void encoder_set_marker(Encoder* _this, [MarshalAs(UnmanagedType.LPStr)] string _marker)
	{
		bgfx_encoder_set_marker(_this,_marker);
	}

	[DllImport(DllName, EntryPoint="bgfx_encoder_set_state", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_encoder_set_state(Encoder* _this, ulong _state, uint _rgba);
	/// <summary>
	...
	///
	public unsafe void encoder_set_state(Encoder* _this, ulong _state, uint _rgba)
	{
	...
	private static extern unsafe void bgfx_encoder_set_condition(Encoder* _this, OcclusionQueryHandle _handle, bool _visible);
	/// <summary>
	...
	///
	public unsafe void encoder_set_condition(Encoder* _this, OcclusionQueryHandle _handle, bool _visible)
	{
	...
	private static extern unsafe void bgfx_encoder_set_stencil(Encoder* _this, uint _fstencil, uint _bstencil);
	/// <summary>
	...
	///
	public unsafe void encoder_set_stencil(Encoder* _this, uint _fstencil, uint _bstencil)
	{
	...
	private static extern unsafe ushort bgfx_encoder_set_scissor(Encoder* _this, ushort _x, ushort _y, ushort _width, ushort _height);
	/// <summary>
	...
	/// <param name="_height">Height of view scissor region.</param>
	///
	public unsafe ushort encoder_set_scissor(Encoder* _this, ushort _x, ushort _y, ushort _width, ushort _height)
	{
	...
	private static extern unsafe void bgfx_encoder_set_scissor_cached(Encoder* _this, ushort _cache);
	/// <summary>
	...
	///
	public unsafe void encoder_set_scissor_cached(Encoder* _this, ushort _cache)
	{
	...
	private static extern unsafe uint bgfx_encoder_set_transform(Encoder* _this, void* _mtx, ushort _num);
	/// <summary>
	...
	///
	public unsafe uint encoder_set_transform(Encoder* _this, void* _mtx, ushort _num)
	{
	...
	private static extern unsafe void bgfx_encoder_set_transform_cached(Encoder* _this, uint _cache, ushort _num);
	/// <summary>
	...
	///
	public unsafe void encoder_set_transform_cached(Encoder* _this, uint _cache, ushort _num)
	{
	...
	private static extern unsafe uint bgfx_encoder_alloc_transform(Encoder* _this, Transform* _transform, ushort _num);
	/// <summary>
	...
	///
	public unsafe uint encoder_alloc_transform(Encoder* _this, Transform* _transform, ushort _num)
	{
	...
	private static extern unsafe void bgfx_encoder_set_uniform(Encoder* _this, UniformHandle _handle, void* _value, ushort _num);
	/// <summary>
	...
	///
	public unsafe void encoder_set_uniform(Encoder* _this, UniformHandle _handle, void* _value, ushort _num)
	{
	...
	private static extern unsafe void bgfx_encoder_set_index_buffer(Encoder* _this, IndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
	/// <summary>
	...
	///
	public unsafe void encoder_set_index_buffer(Encoder* _this, IndexBufferHandle _handle, uint _firstIndex, uint _numIndices)
	{
	...
	private static extern unsafe void bgfx_encoder_set_dynamic_index_buffer(Encoder* _this, DynamicIndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
	/// <summary>
	/// Set index buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_numIndices">Number of indices to render.</param>
	///
	public unsafe void encoder_set_dynamic_index_buffer(Encoder* _this, DynamicIndexBufferHandle _handle, uint _firstIndex, uint _numIndices)
	{
	...
	private static extern unsafe void bgfx_encoder_set_transient_index_buffer(Encoder* _this, TransientIndexBuffer* _tib, uint _firstIndex, uint _numIndices);
	/// <summary>
	/// Set index buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_numIndices">Number of indices to render.</param>
	///
	public unsafe void encoder_set_transient_index_buffer(Encoder* _this, TransientIndexBuffer* _tib, uint _firstIndex, uint _numIndices)
	{
	...
	private static extern unsafe void bgfx_encoder_set_vertex_buffer(Encoder* _this, byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	/// <summary>
	...
	///
	public unsafe void encoder_set_vertex_buffer(Encoder* _this, byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices)
	{
	...
	private static extern unsafe void bgfx_encoder_set_vertex_buffer_with_layout(Encoder* _this, byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	/// <summary>
	/// Set vertex buffer for draw primitive.
	/// </summary>
	///
	...
	///
	public unsafe void encoder_set_vertex_buffer_with_layout(Encoder* _this, byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle)
	{
	...
	private static extern unsafe void bgfx_encoder_set_dynamic_vertex_buffer(Encoder* _this, byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	/// <summary>
	/// Set vertex buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_numVertices">Number of vertices to render.</param>
	///
	public unsafe void encoder_set_dynamic_vertex_buffer(Encoder* _this, byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices)
	{
	...
	private static extern unsafe void bgfx_encoder_set_dynamic_vertex_buffer_with_layout(Encoder* _this, byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	public unsafe void encoder_set_dynamic_vertex_buffer_with_layout(Encoder* _this, byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle)
	{
	...
	private static extern unsafe void bgfx_encoder_set_transient_vertex_buffer(Encoder* _this, byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices);
	/// <summary>
	/// Set vertex buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_numVertices">Number of vertices to render.</param>
	///
	public unsafe void encoder_set_transient_vertex_buffer(Encoder* _this, byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices)
	{
	...
	private static extern unsafe void bgfx_encoder_set_transient_vertex_buffer_with_layout(Encoder* _this, byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	/// <summary>
	/// Set vertex buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
	///
	public unsafe void encoder_set_transient_vertex_buffer_with_layout(Encoder* _this, byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle)
	{
	...
	private static extern unsafe void bgfx_encoder_set_vertex_count(Encoder* _this, uint _numVertices);
	/// <summary>
	...
	///
	public unsafe void encoder_set_vertex_count(Encoder* _this, uint _numVertices)
	{
	...
	private static extern unsafe void bgfx_encoder_set_instance_data_buffer(Encoder* _this, InstanceDataBuffer* _idb, uint _start, uint _num);
	/// <summary>
	...
	///
	public unsafe void encoder_set_instance_data_buffer(Encoder* _this, InstanceDataBuffer* _idb, uint _start, uint _num)
	{
	...
	private static extern unsafe void bgfx_encoder_set_instance_data_from_vertex_buffer(Encoder* _this, VertexBufferHandle _handle, uint _startVertex, uint _num);
	/// <summary>
	/// Set instance data buffer for draw primitive.
	/// </summary>
	///
	...
	///
	public unsafe void encoder_set_instance_data_from_vertex_buffer(Encoder* _this, VertexBufferHandle _handle, uint _startVertex, uint _num)
	{
	...
	private static extern unsafe void bgfx_encoder_set_instance_data_from_dynamic_vertex_buffer(Encoder* _this, DynamicVertexBufferHandle _handle, uint _startVertex, uint _num);
	/// <summary>
	/// Set instance data buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_num">Number of data instances.</param>
	///
	public unsafe void encoder_set_instance_data_from_dynamic_vertex_buffer(Encoder* _this, DynamicVertexBufferHandle _handle, uint _startVertex, uint _num)
	{
	...
	private static extern unsafe void bgfx_encoder_set_instance_count(Encoder* _this, uint _numInstances);
	/// <summary>
	...
	/// </summary>
	///
	public unsafe void encoder_set_instance_count(Encoder* _this, uint _numInstances)
	{
	...
	private static extern unsafe void bgfx_encoder_set_texture(Encoder* _this, byte _stage, UniformHandle _sampler, TextureHandle _handle, uint _flags);
	/// <summary>
	...
	///
	public unsafe void encoder_set_texture(Encoder* _this, byte _stage, UniformHandle _sampler, TextureHandle _handle, uint _flags)
	{
	...
	private static extern unsafe void bgfx_encoder_touch(Encoder* _this, ushort _id);
	/// <summary>
	...
	/// <param name="_id">View id.</param>
	///
	public unsafe void encoder_touch(Encoder* _this, ushort _id)
	{
		bgfx_encoder_touch(_this,_id);
	}

	[DllImport(DllName, EntryPoint="bgfx_encoder_submit", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_encoder_submit(Encoder* _this, ushort _id, ProgramHandle _program, uint _depth, byte _flags);
	/// <summary>
	...
	///
	public unsafe void encoder_submit(Encoder* _this, ushort _id, ProgramHandle _program, uint _depth, byte _flags)
	{
	...
	private static extern unsafe void bgfx_encoder_submit_occlusion_query(Encoder* _this, ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, byte _flags);
	/// <summary>
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	public unsafe void encoder_submit_occlusion_query(Encoder* _this, ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, byte _flags)
	{
	...
	private static extern unsafe void bgfx_encoder_submit_indirect(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, byte _flags);
	/// <summary>
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	public unsafe void encoder_submit_indirect(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, byte _flags)
	{
	...
	private static extern unsafe void bgfx_encoder_set_compute_index_buffer(Encoder* _this, byte _stage, IndexBufferHandle _handle, Access _access);
	/// <summary>
	...
	///
	public unsafe void encoder_set_compute_index_buffer(Encoder* _this, byte _stage, IndexBufferHandle _handle, Access _access)
	{
	...
	private static extern unsafe void bgfx_encoder_set_compute_vertex_buffer(Encoder* _this, byte _stage, VertexBufferHandle _handle, Access _access);
	/// <summary>
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	public unsafe void encoder_set_compute_vertex_buffer(Encoder* _this, byte _stage, VertexBufferHandle _handle, Access _access)
	{
	...
	private static extern unsafe void bgfx_encoder_set_compute_dynamic_index_buffer(Encoder* _this, byte _stage, DynamicIndexBufferHandle _handle, Access _access);
	/// <summary>
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	public unsafe void encoder_set_compute_dynamic_index_buffer(Encoder* _this, byte _stage, DynamicIndexBufferHandle _handle, Access _access)
	{
	...
	private static extern unsafe void bgfx_encoder_set_compute_dynamic_vertex_buffer(Encoder* _this, byte _stage, DynamicVertexBufferHandle _handle, Access _access);
	/// <summary>
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	public unsafe void encoder_set_compute_dynamic_vertex_buffer(Encoder* _this, byte _stage, DynamicVertexBufferHandle _handle, Access _access)
	{
	...
	private static extern unsafe void bgfx_encoder_set_compute_indirect_buffer(Encoder* _this, byte _stage, IndirectBufferHandle _handle, Access _access);
	/// <summary>
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	public unsafe void encoder_set_compute_indirect_buffer(Encoder* _this, byte _stage, IndirectBufferHandle _handle, Access _access)
	{
	...
	private static extern unsafe void bgfx_encoder_set_image(Encoder* _this, byte _stage, TextureHandle _handle, byte _mip, Access _access, TextureFormat _format);
	/// <summary>
	...
	/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
	///
	public unsafe void encoder_set_image(Encoder* _this, byte _stage, TextureHandle _handle, byte _mip, Access _access, TextureFormat _format)
	{
	...
	private static extern unsafe void bgfx_encoder_dispatch(Encoder* _this, ushort _id, ProgramHandle _program, uint _numX, uint _numY, uint _numZ, byte _flags);
	/// <summary>
	/// Dispatch compute.
	/// </summary>
	///
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	public unsafe void encoder_dispatch(Encoder* _this, ushort _id, ProgramHandle _program, uint _numX, uint _numY, uint _numZ, byte _flags)
	{
	...
	private static extern unsafe void bgfx_encoder_dispatch_indirect(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, byte _flags);
	/// <summary>
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	public unsafe void encoder_dispatch_indirect(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, byte _flags)
	{
	...
	private static extern unsafe void bgfx_encoder_discard(Encoder* _this, byte _flags);
	/// <summary>
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	public unsafe void encoder_discard(Encoder* _this, byte _flags)
	{
	...
	private static extern unsafe void bgfx_encoder_blit(Encoder* _this, ushort _id, TextureHandle _dst, byte _dstMip, ushort _dstX, ushort _dstY, ushort _dstZ, TextureHandle _src, byte _srcMip, ushort _srcX, ushort _srcY, ushort _srcZ, ushort _width, ushort _height, ushort _depth);
	/// <summary>
	...
	///
	public unsafe void encoder_blit(Encoder* _this, ushort _id, TextureHandle _dst, byte _dstMip, ushort _dstX, ushort _dstY, ushort _dstZ, TextureHandle _src, byte _srcMip, ushort _srcX, ushort _srcY, ushort _srcZ, ushort _width, ushort _height, ushort _depth)
	{
	...
	private static extern unsafe void bgfx_request_screen_shot(FrameBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _filePath);
	/// <summary>
	...
	///
	public unsafe void request_screen_shot(FrameBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _filePath)
	{
	...
	private static extern unsafe RenderFrame bgfx_render_frame(int _msecs);
	/// <summary>
	/// Render frame.
	...
	///
	public unsafe RenderFrame render_frame(int _msecs)
	{
	...
	private static extern unsafe void bgfx_set_platform_data(PlatformData* _data);
	/// <summary>
	/// Set platform data.
	...
	///
	public unsafe void set_platform_data(PlatformData* _data)
	{
	...
	private static extern unsafe InternalData* bgfx_get_internal_data();
	/// <summary>
	...
	/// </summary>
	///
	public unsafe InternalData* get_internal_data()
	{
	...
	private static extern unsafe UIntPtr bgfx_override_internal_texture_ptr(TextureHandle _handle, UIntPtr _ptr);
	/// <summary>
	...
	///
	public unsafe UIntPtr override_internal_texture_ptr(TextureHandle _handle, UIntPtr _ptr)
	{
	...
	private static extern unsafe UIntPtr bgfx_override_internal_texture(TextureHandle _handle, ushort _width, ushort _height, byte _numMips, TextureFormat _format, ulong _flags);
	/// <summary>
	...
	/// <param name="_flags">Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.</param>
	///
	public unsafe UIntPtr override_internal_texture(TextureHandle _handle, ushort _width, ushort _height, byte _numMips, TextureFormat _format, ulong _flags)
	{
	...
	private static extern unsafe void bgfx_set_marker([MarshalAs(UnmanagedType.LPStr)] string _marker);
	/// <summary>
	/// Sets a debug marker. This allows you to group graphics calls together for easy browsing in
	/// graphics debugging tools.
	/// </summary>
	...
	/// <param name="_marker">Marker string.</param>
	///
	public unsafe void set_marker([MarshalAs(UnmanagedType.LPStr)] string _marker)
	{
		bgfx_set_marker(_marker);
	}

	[DllImport(DllName, EntryPoint="bgfx_set_state", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_set_state(ulong _state, uint _rgba);
	/// <summary>
	/// Set render states for draw primitive.
	/// @remarks
	///   1. To setup more complex states use:
	...
	/// <param name="_rgba">Sets blend factor used by `BGFX_STATE_BLEND_FACTOR` and   `BGFX_STATE_BLEND_INV_FACTOR` blend modes.</param>
	///
	public unsafe void set_state(ulong _state, uint _rgba)
	{
		bgfx_set_state(_state,_rgba);
	}

	[DllImport(DllName, EntryPoint="bgfx_set_condition", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_set_condition(OcclusionQueryHandle _handle, bool _visible);
	/// <summary>
	/// Set condition for rendering.
	/// </summary>
	///
	...
	/// <param name="_visible">Render if occlusion query is visible.</param>
	///
	public unsafe void set_condition(OcclusionQueryHandle _handle, bool _visible)
	{
	...
	private static extern unsafe void bgfx_set_stencil(uint _fstencil, uint _bstencil);
	/// <summary>
	/// Set stencil test state.
	/// </summary>
	///
	...
	/// <param name="_bstencil">Back stencil state. If back is set to `BGFX_STENCIL_NONE` _fstencil is applied to both front and back facing primitives.</param>
	///
	public unsafe void set_stencil(uint _fstencil, uint _bstencil)
	{
	...
	private static extern unsafe ushort bgfx_set_scissor(ushort _x, ushort _y, ushort _width, ushort _height);
	/// <summary>
	/// Set scissor for draw primitive.
	/// @remark
	///   To scissor for all primitives in view see `bgfx::setViewScissor`.
	...
	/// <param name="_height">Height of view scissor region.</param>
	///
	public unsafe ushort set_scissor(ushort _x, ushort _y, ushort _width, ushort _height)
	{
	...
	private static extern unsafe void bgfx_set_scissor_cached(ushort _cache);
	/// <summary>
	/// Set scissor from cache for draw primitive.
	/// @remark
	///   To scissor for all primitives in view see `bgfx::setViewScissor`.
	...
	/// <param name="_cache">Index in scissor cache.</param>
	///
	public unsafe void set_scissor_cached(ushort _cache)
	{
		bgfx_set_scissor_cached(_cache);
	}

	[DllImport(DllName, EntryPoint="bgfx_set_transform", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe uint bgfx_set_transform(void* _mtx, ushort _num);
	/// <summary>
	/// Set model matrix for draw primitive. If it is not called,
	/// the model will be rendered with an identity model matrix.
	/// </summary>
	...
	/// <param name="_num">Number of matrices in array.</param>
	///
	public unsafe uint set_transform(void* _mtx, ushort _num)
	{
	...
	private static extern unsafe void bgfx_set_transform_cached(uint _cache, ushort _num);
	/// <summary>
	///  Set model matrix from matrix cache for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_num">Number of matrices from cache.</param>
	///
	public unsafe void set_transform_cached(uint _cache, ushort _num)
	{
	...
	private static extern unsafe uint bgfx_alloc_transform(Transform* _transform, ushort _num);
	/// <summary>
	/// Reserve matrices in internal matrix cache.
	/// @attention Pointer returned can be modifed until `bgfx::frame` is called.
	/// </summary>
	...
	/// <param name="_num">Number of matrices.</param>
	///
	public unsafe uint alloc_transform(Transform* _transform, ushort _num)
	{
	...
	private static extern unsafe void bgfx_set_uniform(UniformHandle _handle, void* _value, ushort _num);
	/// <summary>
	/// Set shader uniform parameter for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_num">Number of elements. Passing `UINT16_MAX` will use the _num passed on uniform creation.</param>
	///
	public unsafe void set_uniform(UniformHandle _handle, void* _value, ushort _num)
	{
	...
	private static extern unsafe void bgfx_set_index_buffer(IndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
	/// <summary>
	/// Set index buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_numIndices">Number of indices to render.</param>
	///
	public unsafe void set_index_buffer(IndexBufferHandle _handle, uint _firstIndex, uint _numIndices)
	{
	...
	private static extern unsafe void bgfx_set_dynamic_index_buffer(DynamicIndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
	/// <summary>
	/// Set index buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_numIndices">Number of indices to render.</param>
	///
	public unsafe void set_dynamic_index_buffer(DynamicIndexBufferHandle _handle, uint _firstIndex, uint _numIndices)
	{
	...
	private static extern unsafe void bgfx_set_transient_index_buffer(TransientIndexBuffer* _tib, uint _firstIndex, uint _numIndices);
	/// <summary>
	/// Set index buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_numIndices">Number of indices to render.</param>
	///
	public unsafe void set_transient_index_buffer(TransientIndexBuffer* _tib, uint _firstIndex, uint _numIndices)
	{
	...
	private static extern unsafe void bgfx_set_vertex_buffer(byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	/// <summary>
	/// Set vertex buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_numVertices">Number of vertices to render.</param>
	///
	public unsafe void set_vertex_buffer(byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices)
	{
	...
	private static extern unsafe void bgfx_set_vertex_buffer_with_layout(byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	/// <summary>
	/// Set vertex buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
	///
	public unsafe void set_vertex_buffer_with_layout(byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle)
	{
	...
	private static extern unsafe void bgfx_set_dynamic_vertex_buffer(byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices);
	/// <summary>
	/// Set vertex buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_numVertices">Number of vertices to render.</param>
	///
	public unsafe void set_dynamic_vertex_buffer(byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices)
	{
	...
	private static extern unsafe void bgfx_set_dynamic_vertex_buffer_with_layout(byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	/// <summary>
	/// Set vertex buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
	///
	public unsafe void set_dynamic_vertex_buffer_with_layout(byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle)
	{
	...
	private static extern unsafe void bgfx_set_transient_vertex_buffer(byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices);
	/// <summary>
	/// Set vertex buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_numVertices">Number of vertices to render.</param>
	///
	public unsafe void set_transient_vertex_buffer(byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices)
	{
	...
	private static extern unsafe void bgfx_set_transient_vertex_buffer_with_layout(byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
	/// <summary>
	/// Set vertex buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_layoutHandle">Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for creation of vertex buffer will be used.</param>
	///
	public unsafe void set_transient_vertex_buffer_with_layout(byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle)
	{
	...
	private static extern unsafe void bgfx_set_vertex_count(uint _numVertices);
	/// <summary>
	/// Set number of vertices for auto generated vertices use in conjuction
	/// with gl_VertexID.
	/// @attention Availability depends on: `BGFX_CAPS_VERTEX_ID`.
	...
	/// <param name="_numVertices">Number of vertices.</param>
	///
	public unsafe void set_vertex_count(uint _numVertices)
	{
	...
	private static extern unsafe void bgfx_set_instance_data_buffer(InstanceDataBuffer* _idb, uint _start, uint _num);
	/// <summary>
	/// Set instance data buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_num">Number of data instances.</param>
	///
	public unsafe void set_instance_data_buffer(InstanceDataBuffer* _idb, uint _start, uint _num)
	{
	...
	private static extern unsafe void bgfx_set_instance_data_from_vertex_buffer(VertexBufferHandle _handle, uint _startVertex, uint _num);
	/// <summary>
	/// Set instance data buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_num">Number of data instances. Set instance data buffer for draw primitive.</param>
	///
	public unsafe void set_instance_data_from_vertex_buffer(VertexBufferHandle _handle, uint _startVertex, uint _num)
	{
	...
	private static extern unsafe void bgfx_set_instance_data_from_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle, uint _startVertex, uint _num);
	/// <summary>
	/// Set instance data buffer for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_num">Number of data instances.</param>
	///
	public unsafe void set_instance_data_from_dynamic_vertex_buffer(DynamicVertexBufferHandle _handle, uint _startVertex, uint _num)
	{
	...
	private static extern unsafe void bgfx_set_instance_count(uint _numInstances);
	/// <summary>
	/// Set number of instances for auto generated instances use in conjuction
	/// with gl_InstanceID.
	/// @attention Availability depends on: `BGFX_CAPS_VERTEX_ID`.
	/// </summary>
	///
	public unsafe void set_instance_count(uint _numInstances)
	{
	...
	private static extern unsafe void bgfx_set_texture(byte _stage, UniformHandle _sampler, TextureHandle _handle, uint _flags);
	/// <summary>
	/// Set texture stage for draw primitive.
	/// </summary>
	///
	...
	/// <param name="_flags">Texture sampling mode. Default value UINT32_MAX uses   texture sampling settings from the texture.   - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp to edge wrap     mode.   - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic     sampling.</param>
	///
	public unsafe void set_texture(byte _stage, UniformHandle _sampler, TextureHandle _handle, uint _flags)
	{
	...
	private static extern unsafe void bgfx_touch(ushort _id);
	/// <summary>
	/// Submit an empty primitive for rendering. Uniforms and draw state
	...
	/// <param name="_id">View id.</param>
	///
	public unsafe void touch(ushort _id)
	{
		bgfx_touch(_id);
	}

	[DllImport(DllName, EntryPoint="bgfx_submit", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_submit(ushort _id, ProgramHandle _program, uint _depth, byte _flags);
	/// <summary>
	/// Submit primitive for rendering.
	/// </summary>
	///
	...
	///
	public unsafe void submit(ushort _id, ProgramHandle _program, uint _depth, byte _flags)
	{
	...
	private static extern unsafe void bgfx_submit_occlusion_query(ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, byte _flags);
	/// <summary>
	/// Submit primitive with occlusion query for rendering.
	/// </summary>
	///
	...
	/// <param name="_flags">Which states to discard for next draw. See `BGFX_DISCARD_*`.</param>
	///
	public unsafe void submit_occlusion_query(ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, byte _flags)
	{
	...
	private static extern unsafe void bgfx_submit_indirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, byte _flags);
	/// <summary>
	/// Submit primitive for rendering with index and instance data info from
	/// indirect buffer.
	/// </summary>
	...
	/// <param name="_flags">Which states to discard for next draw. See `BGFX_DISCARD_*`.</param>
	///
	public unsafe void submit_indirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, byte _flags)
	{
	...
	private static extern unsafe void bgfx_set_compute_index_buffer(byte _stage, IndexBufferHandle _handle, Access _access);
	/// <summary>
	/// Set compute index buffer.
	/// </summary>
	///
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	public unsafe void set_compute_index_buffer(byte _stage, IndexBufferHandle _handle, Access _access)
	{
	...
	private static extern unsafe void bgfx_set_compute_vertex_buffer(byte _stage, VertexBufferHandle _handle, Access _access);
	/// <summary>
	/// Set compute vertex buffer.
	/// </summary>
	///
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	public unsafe void set_compute_vertex_buffer(byte _stage, VertexBufferHandle _handle, Access _access)
	{
	...
	private static extern unsafe void bgfx_set_compute_dynamic_index_buffer(byte _stage, DynamicIndexBufferHandle _handle, Access _access);
	/// <summary>
	/// Set compute dynamic index buffer.
	/// </summary>
	///
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	public unsafe void set_compute_dynamic_index_buffer(byte _stage, DynamicIndexBufferHandle _handle, Access _access)
	{
	...
	private static extern unsafe void bgfx_set_compute_dynamic_vertex_buffer(byte _stage, DynamicVertexBufferHandle _handle, Access _access);
	/// <summary>
	/// Set compute dynamic vertex buffer.
	/// </summary>
	///
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	public unsafe void set_compute_dynamic_vertex_buffer(byte _stage, DynamicVertexBufferHandle _handle, Access _access)
	{
	...
	private static extern unsafe void bgfx_set_compute_indirect_buffer(byte _stage, IndirectBufferHandle _handle, Access _access);
	/// <summary>
	/// Set compute indirect buffer.
	/// </summary>
	///
	...
	/// <param name="_access">Buffer access. See `Access::Enum`.</param>
	///
	public unsafe void set_compute_indirect_buffer(byte _stage, IndirectBufferHandle _handle, Access _access)
	{
	...
	private static extern unsafe void bgfx_set_image(byte _stage, TextureHandle _handle, byte _mip, Access _access, TextureFormat _format);
	/// <summary>
	/// Set compute image from texture.
	/// </summary>
	///
	...
	/// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
	///
	public unsafe void set_image(byte _stage, TextureHandle _handle, byte _mip, Access _access, TextureFormat _format)
	{
	...
	private static extern unsafe void bgfx_dispatch(ushort _id, ProgramHandle _program, uint _numX, uint _numY, uint _numZ, byte _flags);
	/// <summary>
	/// Dispatch compute.
	/// </summary>
	///
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	public unsafe void dispatch(ushort _id, ProgramHandle _program, uint _numX, uint _numY, uint _numZ, byte _flags)
	{
	...
	private static extern unsafe void bgfx_dispatch_indirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, byte _flags);
	/// <summary>
	/// Dispatch compute indirect.
	/// </summary>
	///
	...
	/// <param name="_flags">Discard or preserve states. See `BGFX_DISCARD_*`.</param>
	///
	public unsafe void dispatch_indirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, byte _flags)
	{
	...
	private static extern unsafe void bgfx_discard(byte _flags);
	/// <summary>
	/// Discard previously set state for draw or compute call.
	/// </summary>
	///
	...
	///
	public unsafe void discard(byte _flags)
	{
		bgfx_discard(_flags);
	}

	[DllImport(DllName, EntryPoint="bgfx_blit", CallingConvention = CallingConvention.Cdecl)]
	private static extern unsafe void bgfx_blit(ushort _id, TextureHandle _dst, byte _dstMip, ushort _dstX, ushort _dstY, ushort _dstZ, TextureHandle _src, byte _srcMip, ushort _srcX, ushort _srcY, ushort _srcZ, ushort _width, ushort _height, ushort _depth);
	/// <summary>
	/// Blit 2D texture region between two 2D textures.
	/// @attention Destination texture must be created with `BGFX_TEXTURE_BLIT_DST` flag.
	/// @attention Availability depends on: `BGFX_CAPS_TEXTURE_BLIT`.
	...
	/// <param name="_depth">If texture is 3D this argument represents depth of region, otherwise it's unused.</param>
	///
	public unsafe void blit(ushort _id, TextureHandle _dst, byte _dstMip, ushort _dstX, ushort _dstY, ushort _dstZ, TextureHandle _src, byte _srcMip, ushort _srcX, ushort _srcY, ushort _srcZ, ushort _width, ushort _height, ushort _depth)
	{
